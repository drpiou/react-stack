import Qe, { useState as Ha, useCallback as ce, useRef as er, useMemo as pa, useEffect as rt, createContext as Va, useContext as Ja } from "react";
var Ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xa = typeof Ke == "object" && Ke && Ke.Object === Object && Ke, va = Xa, Za = va, Qa = typeof self == "object" && self && self.Object === Object && self, en = Za || Qa || Function("return this")(), K = en, rn = K, tn = rn.Symbol, rr = tn, vt = rr, da = Object.prototype, an = da.hasOwnProperty, nn = da.toString, Be = vt ? vt.toStringTag : void 0;
function on(e) {
  var t = an.call(e, Be), a = e[Be];
  try {
    e[Be] = void 0;
    var i = !0;
  } catch {
...
var Pn = En;
(function(e, t) {
  var a = K, i = Pn, u = t && !t.nodeType && t, s = u && !0 && e && !e.nodeType && e, l = s && s.exports === u, f = l ? a.Buffer : void 0, p = f ? f.isBuffer : void 0, v = p || i;
  e.exports = v;
})(Je, Je.exports);
var Br = { exports: {} };
(function(e, t) {
...
var ti = ri, ai = Mn, ni = Kn, ii = Jn, oi = Qn, si = ti;
function fe(e) {
...
fe.prototype.clear = ai;
fe.prototype.delete = ni;
fe.prototype.get = ii;
fe.prototype.has = oi;
fe.prototype.set = si;
var ui = fe, ci = K, fi = ci["__core-js_shared__"], li = fi, Fr = li, gt = function() {
...
var le = Di, ki = le, Fi = K, Li = ki(Fi, "Map"), ba = Li, Mi = le, Ni = Mi(Object, "create"), ar = Ni, bt = ar;
function Gi() {
...
var Bi = zi, Wi = ar, qi = "__lodash_hash_undefined__", Yi = Object.prototype, Ki = Yi.hasOwnProperty;
function Hi(e) {
  var t = this.__data__;
  if (Wi) {
    var a = t[e];
...
pe.prototype.clear = io;
pe.prototype.delete = oo;
pe.prototype.get = so;
pe.prototype.has = uo;
pe.prototype.set = co;
var fo = pe, $t = fo, lo = ui, po = ba;
function vo() {
...
Ot && Ot.valueOf;
var No = le, Go = K, Uo = No(Go, "DataView"), zo = Uo, Bo = le, Wo = K, qo = Bo(Wo, "Promise"), Yo = qo, Ko = le, Ho = K, Vo = Ko(Ho, "Set"), Jo = Vo, Xo = le, Zo = K, Qo = Xo(Zo, "WeakMap"), es = Qo, Wr = zo, qr = ba, Yr = Yo, Kr = Jo, Hr = es, $a = tt, de = ga, Tt = "[object Map]", rs = "[object Object]", wt = "[object Promise]", jt = "[object Set]", Et = "[object WeakMap]", Pt = "[object DataView]", ts = de(Wr), as = de(qr), ns = de(Yr), is = de(Kr), os = de(Hr), oe = $a;
(Wr && oe(new Wr(new ArrayBuffer(1))) != Pt || qr && oe(new qr()) != Tt || Yr && oe(Yr.resolve()) != wt || Kr && oe(new Kr()) != jt || Hr && oe(new Hr()) != Et) && (oe = function(e) {
  var t = $a(e), a = t == rs ? e.constructor : void 0, i = a ? de(a) : "";
  if (i)
    switch (i) {
      case ts:
        return Pt;
...
function _s() {
  return It || (It = 1, function(e) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      e.Fragment = 60107;
      var s = 60108, l = 60114, f = 60109, p = 60110, v = 60112, y = 60113, m = 60120, _ = 60115, E = 60116, P = 60121, C = 60122, R = 60117, k = 60129, F = 60131;
      if (typeof Symbol == "function" && Symbol.for) {
        var $ = Symbol.for;
        i = $("react.element"), u = $("react.portal"), e.Fragment = $("react.fragment"), s = $("react.strict_mode"), l = $("react.profiler"), f = $("react.provider"), p = $("react.context"), v = $("react.forward_ref"), y = $("react.suspense"), m = $("react.suspense_list"), _ = $("react.memo"), E = $("react.lazy"), P = $("react.block"), C = $("react.server.block"), R = $("react.fundamental"), $("react.scope"), $("react.opaque.id"), k = $("react.debug_trace_mode"), $("react.offscreen"), F = $("react.legacy_hidden");
      }
      ...
      var pr = !1;
      function vr(r) {
        return !!(typeof r == "string" || typeof r == "function" || r === e.Fragment || r === l || r === k || r === s || r === y || r === m || r === F || pr || typeof r == "object" && r !== null && (r.$$typeof === E || r.$$typeof === _ || r.$$typeof === f || r.$$typeof === p || r.$$typeof === v || r.$$typeof === R || r.$$typeof === P || r[0] === C));
      }
      function dr(r, n, o) {
      ...
      function yr() {
        {
          if (U === 0) {
            Oe = console.log, Te = console.info, we = console.warn, je = console.error, Ee = console.group, Pe = console.groupCollapsed, Se = console.groupEnd;
            var r = {
              configurable: !0,
              enumerable: !0,
              value: Ce,
      ...
      var J = D.ReactCurrentDispatcher, X;
      function B(r, n, o) {
        {
          if (X === void 0)
            try {
...
`), j = c.stack.split(`
`), O = d.length - 1, T = j.length - 1; O >= 1 && T >= 0 && d[O] !== j[T]; )
              T--;
            for (; O >= 1 && T >= 0; O--, T--)
              if (d[O] !== j[T]) {
                if (O !== 1 || T !== 1)
...
` + d[O].replace(" at new ", " at ");
                      return typeof r == "function" && W.set(r, x), x;
                    }
                  while (O >= 1 && T >= 0);
                break;
              }
        ...
        var N = r ? r.displayName || r.name : "", ze = N ? B(N) : "";
        return typeof r == "function" && W.set(r, ze), ze;
      }
      function Re(r, n, o) {
        return Ae(r, !1);
      }
      ...
      var xe = {}, Ie = D.ReactDebugCurrentFrame;
      function Y(r) {
        if (r) {
            ...
            if (b(r, h)) {
              ...
              try {
                if (typeof r[h] != "function") {
                  var j = Error((c || "React class") + ": " + o + " type `" + h + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof r[h] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
              ...
              d && !(d instanceof Error) && (Y(g), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", c || "React class", o, h, typeof d), Y(null)), d instanceof Error && !(d.message in xe) && (xe[d.message] = !0, Y(g), w("Failed %s type: %s", o, d.message), Y(null));
            }
        }
      }
      var z = D.ReactCurrentOwner, Q = Object.prototype.hasOwnProperty, $r = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
      ...
      function jr(r, n) {
        {
          var o = function() {
            ke || (ke = !0, w("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", n));
          };
      ...
      function Pr(r, n, o, c, g) {
        {
          var b, h = {}, d = null, j = null;
          o !== void 0 && (d = "" + o), Or(n) && (d = "" + n.key), mr(n) && (j = n.ref, Tr(n, g));
          for (b in n)
          ...
          return Er(r, d, j, g, c, z.current, h);
        }
      }
      var re = D.ReactCurrentOwner, Fe = D.ReactDebugCurrentFrame;
      function M(r) {
        if (r) {
          var n = r._owner, o = q(r.type, r._source, n ? n.type : null);
      ...
      function Ne(r, n) {
        {
          ...
          Me[o] = !0;
          var c = "";
          r && r._owner && r._owner !== re.current && (c = " It was passed a child from " + A(r._owner.type) + "."), M(r), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', o, c), M(null);
        }
      }
      function Ge(r, n) {
        {
      ...
      function Rr(r) {
        {
          for (var n = Object.keys(r.props), o = 0; o < n.length; o++) {
            var c = n[o];
            if (c !== "children" && c !== "key") {
              M(r), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", c), M(null);
              break;
            }
          }
          r.ref !== null && (M(r), w("Invalid attribute `ref` supplied to `React.Fragment`."), M(null));
        }
      }
      function Ue(r, n, o, c, g, b) {
        {
          var h = vr(r);
          if (!h) {
            var d = "";
            ...
            j ? d += j : d += Le();
            var O;
            r === null ? O = "null" : Array.isArray(r) ? O = "array" : r !== void 0 && r.$$typeof === i ? (O = "<" + (A(r.type) || "Unknown") + " />", d = " Did you accidentally export a JSX literal instead of a component?") : O = typeof r, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", O, d);
          }
          var T = Pr(r, n, o, g, b);
          if (T == null)
            return T;
...
var Cs = Ss, As = typeof He == "object" && He && He.Object === Object && He, ja = As, Rs = ja, xs = typeof self == "object" && self && self.Object === Object && self, Is = Rs || xs || Function("return this")(), H = Is, Ds = H, ks = Ds.Symbol, ir = ks, Dt = ir, Ea = Object.prototype, Fs = Ea.hasOwnProperty, Ls = Ea.toString, We = Dt ? Dt.toStringTag : void 0;
function Ms(e) {
  var t = Fs.call(e, We), a = e[We];
  try {
    e[We] = void 0;
    var i = !0;
  } catch {
  ...
  var u = Ls.call(e);
  return i && (t ? e[We] = a : delete e[We]), u;
}
var Ns = Ms, Gs = Object.prototype, Us = Gs.toString;
function zs(e) {
  return Us.call(e);
}
var Bs = zs, kt = ir, Ws = Ns, qs = Bs, Ys = "[object Null]", Ks = "[object Undefined]", Ft = kt ? kt.toStringTag : void 0;
function Hs(e) {
  return e == null ? e === void 0 ? Ks : Ys : Ft && Ft in Object(e) ? Ws(e) : qs(e);
}
var qe = Hs;
function Vs(e) {
  return e != null && typeof e == "object";
}
var Ye = Vs, Js = qe, Xs = Ye, Zs = "[object Arguments]";
function Qs(e) {
  return Xs(e) && Js(e) == Zs;
}
var eu = Qs, Lt = eu, ru = Ye, Pa = Object.prototype, tu = Pa.hasOwnProperty, au = Pa.propertyIsEnumerable, nu = Lt(function() {
  return arguments;
}()) ? Lt : function(e) {
...
var Wu = Uu, qu = Bu, Mt = Vr.exports, Nt = Mt && Mt.isTypedArray, Yu = Nt ? qu(Nt) : Wu, Aa = Yu, Ku = Cs, Hu = Sa, Vu = V, Ju = Xe.exports, Xu = Ca, Zu = Aa, Qu = Object.prototype, ec = Qu.hasOwnProperty;
function rc(e, t) {
  var a = Vu(e), i = !a && Hu(e), u = !a && !i && Ju(e), s = !a && !i && !u && Zu(e), l = a || i || u || s, f = l ? Ku(e.length, String) : [], p = f.length;
  for (var v in e)
...
var lf = ff, pf = Kc, vf = rf, df = nf, yf = uf, hf = lf;
function ye(e) {
  var t = -1, a = e == null ? 0 : e.length;
  for (this.clear(); ++t < a; ) {
    var i = e[t];
...
ye.prototype.clear = pf;
ye.prototype.delete = vf;
ye.prototype.get = df;
ye.prototype.has = yf;
ye.prototype.set = hf;
var sr = ye, _f = sr;
...
var Hf = Kf, Vf = Yf, Jf = Hf;
function Xf(e, t) {
  var a = Jf(e, t);
  return Vf(a) ? a : void 0;
}
var he = Xf, Zf = he, Qf = H, el = Zf(Qf, "Map"), st = el, rl = he, tl = rl(Object, "create"), ur = tl, Ut = ur;
function al() {
...
_e.prototype.clear = Ol;
_e.prototype.delete = Tl;
_e.prototype.get = wl;
_e.prototype.has = jl;
_e.prototype.set = El;
var Pl = _e, zt = Pl, Sl = sr, Cl = st;
function Al() {
  this.size = 0, this.__data__ = {
    hash: new zt(),
    map: new (Cl || Sl)(),
...
var Kl = Yl, Hl = Rl, Vl = Ml, Jl = Ul, Xl = Wl, Zl = Kl;
function ge(e) {
  var t = -1, a = e == null ? 0 : e.length;
  for (this.clear(); ++t < a; ) {
    var i = e[t];
...
ge.prototype.delete = Vl;
ge.prototype.get = Jl;
ge.prototype.has = Xl;
ge.prototype.set = Zl;
var ut = ge, Ql = sr, ep = st, rp = ut, tp = 200;
function ap(e, t) {
  var a = this.__data__;
  if (a instanceof Ql) {
    var i = a.__data__;
...
be.prototype.clear = op;
be.prototype.delete = sp;
be.prototype.get = up;
be.prototype.has = cp;
be.prototype.set = fp;
var ka = be, lp = "__lodash_hash_undefined__";
function pp(e) {
...
function Cp(e, t, a, i, u, s) {
  ...
  for (s.set(e, t), s.set(t, e); ++m < f; ) {
    var P = e[m], C = t[m];
    if (i)
      var R = l ? i(C, P, m, t, e, s) : i(P, C, m, e, t, s);
    if (R !== void 0) {
      if (R)
        continue;
      _ = !1;
    ...
    if (E) {
      if (!jp(t, function(k, F) {
        if (!Ep(E, F) && (P === k || u(P, k, a, i, s)))
          return E.push(F);
      })) {
        _ = !1;
        break;
...
var Fp = kp, Bt = ir, Wt = xp, Lp = Ia, Mp = Fa, Np = Dp, Gp = Fp, Up = 1, zp = 2, Bp = "[object Boolean]", Wp = "[object Date]", qp = "[object Error]", Yp = "[object Map]", Kp = "[object Number]", Hp = "[object RegExp]", Vp = "[object Set]", Jp = "[object String]", Xp = "[object Symbol]", Zp = "[object ArrayBuffer]", Qp = "[object DataView]", qt = Bt ? Bt.prototype : void 0, Nr = qt ? qt.valueOf : void 0;
...
var cv = uv, fv = wa, lv = cv, pv = Object.prototype, vv = pv.propertyIsEnumerable, Yt = Object.getOwnPropertySymbols, dv = Yt ? function(e) {
  return e == null ? [] : (e = Object(e), fv(Yt(e), function(t) {
    return vv.call(e, t);
  }));
...
var $v = bv, Kt = $v, mv = 1, Ov = Object.prototype, Tv = Ov.hasOwnProperty;
function wv(e, t, a, i, u, s) {
  var l = a & mv, f = Kt(e), p = f.length, v = Kt(t), y = v.length;
  if (p != y && !l)
    return !1;
  for (var m = p; m--; ) {
    var _ = f[m];
  ...
  for (var R = l; ++m < p; ) {
    ...
    var k = e[_], F = t[_];
    if (i)
      var $ = l ? i(F, k, _, t, e, s) : i(k, F, _, e, t, s);
    if (!($ === void 0 ? k === F || u(k, F, a, i, s) : $)) {
      C = !1;
      break;
    }
    R || (R = _ == "constructor");
  ...
  if (C && !R) {
    ...
    L != G && "constructor" in e && "constructor" in t && !(typeof L == "function" && L instanceof L && typeof G == "function" && G instanceof G) && (C = !1);
  }
  return s.delete(e), s.delete(t), C;
}
var jv = wv, Ev = he, Pv = H, Sv = Ev(Pv, "DataView"), Cv = Sv, Av = he, Rv = H, xv = Av(Rv, "Promise"), Iv = xv, Dv = he, kv = H, Fv = Dv(kv, "Set"), Lv = Fv, Mv = he, Nv = H, Gv = Mv(Nv, "WeakMap"), Uv = Gv, Jr = Cv, Xr = st, Zr = Iv, Qr = Lv, et = Uv, La = qe, $e = Da, Ht = "[object Map]", zv = "[object Object]", Vt = "[object Promise]", Jt = "[object Set]", Xt = "[object WeakMap]", Zt = "[object DataView]", Bv = $e(Jr), Wv = $e(Xr), qv = $e(Zr), Yv = $e(Qr), Kv = $e(et), ne = La;
(Jr && ne(new Jr(new ArrayBuffer(1))) != Zt || Xr && ne(new Xr()) != Ht || Zr && ne(Zr.resolve()) != Vt || Qr && ne(new Qr()) != Jt || et && ne(new et()) != Xt) && (ne = function(e) {
  var t = La(e), a = t == zv ? e.constructor : void 0, i = a ? $e(a) : "";
  if (i)
    switch (i) {
      case Bv:
        return Zt;
...
function rd(e, t, a, i, u, s) {
  ...
  if (!(a & Qv)) {
    ...
    if (E || P) {
      var C = E ? e.value() : e, R = P ? t.value() : t;
      return s || (s = new Gr()), u(C, R, a, i, s);
    }
  }
  return _ ? (s || (s = new Gr()), Xv(e, t, a, i, u, s)) : !1;
}
var td = rd, ad = td, ia = Ye;
...
var md = $d, Od = qe, Td = Ye, wd = "[object Symbol]";
function jd(e) {
...
var Bd = zd, oa = ir, Wd = Bd, qd = V, Yd = ct, Kd = 1 / 0, sa = oa ? oa.prototype : void 0, ua = sa ? sa.toString : void 0;
function Ba(e) {
  if (typeof e == "string")
    return e;
  if (qd(e))
...
var zy = Uy, By = Ny, Wy = zy, qy = ft, Yy = fr;
function Ky(e) {
  return qy(e) ? By(Yy(e)) : Wy(e);
}
var Hy = Ky, Vy = md, Jy = ky, Xy = Ly, Zy = V, Qy = Hy;
function eh(e) {
...
function ph() {
  ...
  if (ue.Fragment = 60107, typeof Symbol == "function" && Symbol.for) {
    var a = Symbol.for;
    t = a("react.element"), ue.Fragment = a("react.fragment");
  }
  var i = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, u = Object.prototype.hasOwnProperty, s = { key: !0, ref: !0, __self: !0, __source: !0 };
  function l(f, p, v) {
    var y, m = {}, _ = null, E = null;
...
const dh = pt.exports.jsx, yh = pt.exports.jsxs, _h = (e) => {
  const t = Va({
    show: () => ({
      hide: () => {
      }
  ...
  return [() => {
    ...
    const [m, _] = $s([]), E = ce((R) => {
      ...
      const $ = () => {
        _((D) => sh(D, (w) => w.id !== k));
      }, L = (ie = (G = F.duration) != null ? G : l) != null ? ie : e.defaultDuration;
      return L && v.set($, L), {
        hide: $
      };
    }, [l, _, v]), P = ce(() => {
    ...
    return rt(() => {
      var R;
      (R = y.current) == null || R.call(y, C);
    }, [C]), /* @__PURE__ */ yh(t.Provider, {
      value: C,
      children: [p, /* @__PURE__ */ dh(s, {
        stack: m
      })]
    });
  }];
